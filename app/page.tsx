...
export default function Home() {
  return <main>
    ...
    <section id="install" className="install-section section-pad"><div className="section-shell install-inner"><div className="install-copy"><div className="section-kicker light">09 / Get started</div><h2>Your next task is<br />one sentence away.</h2><p>Install iNeedCodes globally, then talk to it in plain language from any project folder.</p></div><div className="placeholder-grid"><div className="placeholder-card"><span className="placeholder-label">INSTALLATION</span><Terminal /><h3>Install from your terminal</h3><code>npm install -g ineedcodes</code><p>Then start with <strong>ineed</strong>.</p></div><div className="placeholder-card"><span className="placeholder-label">DOCUMENTATION</span><FileEdit /><h3>Read the README</h3><p>Setup, first run, commands, and workflow examples.</p><a className="placeholder-link" href="https://github.com/salsabila2507/ineedcodes#readme" target="_blank" rel="noreferrer">Open README <ArrowUpRight /></a></div><div className="placeholder-card"><span className="placeholder-label">SOURCE</span><GitBranch /><h3>View on GitHub</h3><p>Follow the open-source CLI project.</p><a className="placeholder-link" href="https://github.com/salsabila2507/ineedcodes" target="_blank" rel="noreferrer">github.com/salsabila2507/ineedcodes <ArrowUpRight /></a></div></div></div></section>

    <footer><div className="section-shell footer-top"><div className="footer-brand"><a className="brand" href="#top"><span className="brand-mark"><span>&gt;_</span></span><span>iNeedCodes</span></a><p>Tell it what you want.<br />It figures out how to do it.</p></div><div className="footer-links"><div><b>Product</b><a href="#capabilities">Capabilities</a><a href="#workflow">Workflow</a><a href="#examples">Examples</a></div><div><b>Resources</b><a href="https://ineed.web.id" target="_blank" rel="noreferrer">Learn AI &amp; free resources <ArrowUpRight /></a><a href="https://t.me/ineedofc" target="_blank" rel="noreferrer">Telegram @ineedofc <ArrowUpRight /></a><a href="https://github.com/rtk-ai/icm" target="_blank" rel="noreferrer">ICM <ArrowUpRight /></a></div></div></div><div className="section-shell footer-bottom"><span>© {new Date().getFullYear()} iNeedCodes</span><span>Built for the terminal.</span></div></footer>
  </main>;
}
